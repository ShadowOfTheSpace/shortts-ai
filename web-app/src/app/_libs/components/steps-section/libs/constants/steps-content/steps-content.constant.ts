import { type StepContent } from "../../types/types";

const STEPS_CONTENT: StepContent[] = [
  {
    backgroundImageUrl: "/images/step-1-background-image.svg",
    description:
    ...
    iconName: "testTube",
    imageUrl: "/images/temp-steps-image.png",
    title: "Choose Your Ingredients",
  },
  {
    backgroundImageUrl: "/images/step-2-background-image.svg",
    description:
  ...
  {
    backgroundImageUrl: "/images/step-3-background-image.svg",
    description:
